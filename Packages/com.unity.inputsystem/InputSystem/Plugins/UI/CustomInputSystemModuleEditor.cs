...
{
    [CustomEditor(typeof(CustomInputSystemModule))]
    [InitializeOnLoad]
    internal class CustomInputSystemModuleEditor : UnityEditor.Editor
    {
        static CustomInputSystemModuleEditor()
        {
#if UNITY_6000_0_OR_NEWER && ENABLE_INPUT_SYSTEM
            InputModuleComponentFactory.SetInputModuleComponentOverride(
                go => ObjectFactory.AddComponent<CustomInputSystemModule>(go));
#endif
        }
        ...
        public static void ReassignActions(CustomInputSystemModule module, InputActionAsset action)
        {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                if (actions != null)
                {
                    ...
                    ReassignActions(target as CustomInputSystemModule, actions);
